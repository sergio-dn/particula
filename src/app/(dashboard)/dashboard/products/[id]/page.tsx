...
const componentScoreLabels: Record<string, string> = {
  sales_velocity_score: "Velocidad de ventas",
  restock_frequency_score: "Frecuencia de restock",
  price_stability_score: "Estabilidad de precio",
  availability_score: "Disponibilidad",
  revenue_score: "Ingresos",
                    ...
                    return (
                      <div key={dateKey} className="space-y-2">
                        ...
                        <Table>
                          ...
                          <TableBody>
                            {items.map((se) => {
                              const reasons = Array.isArray(se.reasonCodes)
                                ? (se.reasonCodes as string[])
                                : []
                              return (
                                <TableRow key={se.id}>
                                  <TableCell className="font-medium">
                  ...
                  <div className="flex items-center gap-8">
                    <div className="text-center">
                      <div className="text-5xl font-bold">
                        {Math.round(winnerScore.winnerScore)}
                      </div>
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-semibold">
                        {fmtPct(winnerScore.confidenceScore)}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-muted-foreground">Fecha</div>
                      <div className="text-sm">
                        {fmtDateFull(winnerScore.scoreDate)}
                      </div>
                    </div>
                  </div>

                  {/* Component Scores Breakdown */}
                  {winnerScore.componentScores && (
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {Object.entries(
                          winnerScore.componentScores as Record<string, number>
                        ).map(([key, value]) => (
                          <div
                            key={key}
                  ...
                  {winnerScore.reasonCodes && (
                    <div>
                      ...
                      <div className="flex gap-2 flex-wrap">
                        {(
                          Array.isArray(winnerScore.reasonCodes)
                            ? (winnerScore.reasonCodes as string[])
                            : []
                        ).map((code, idx) => (
                          <Badge
                            key={idx}
